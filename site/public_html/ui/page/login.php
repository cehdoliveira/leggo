    ...
    <div class="row justify-content-center">
        <div class="col-sm-10 col-md-6 col-lg-4">
            ...
            <div class="text-center mb-4">
                ...
                <p class="small" style="color: var(--app-text-muted);">Acesse sua conta em <?php echo htmlspecialchars(constant("cTitle")); ?></p>
            </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-center py-3">
                    <small style="color: var(--app-text-muted);">
                        <a href="<?php echo $GLOBALS['forgot_password_url']; ?>" class="text-decoration-none">Esqueci minha senha</a>
                        &nbsp;·&nbsp;
                        Não tem conta?
                        <a href="<?php echo $GLOBALS['register_url']; ?>" class="text-decoration-none">Cadastre-se</a>
                    </small>
                </div>
            </div>
