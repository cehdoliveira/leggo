    ...
    <div class="row justify-content-center">
        <div class="col-sm-10 col-md-6 col-lg-4">
            ...
            <div class="text-center mb-4">
                ...
                <p class="small" style="color: var(--app-text-muted);">Escolha uma nova senha para a sua conta</p>
            </div>

            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST"
                          action="<?php echo sprintf($GLOBALS['reset_password_url'], $reset_password_token); ?>"
                        ...
                        <button type="submit" class="btn btn-primary w-100" :disabled="isSubmitting">
                            ...
                            <span x-text="isSubmitting ? 'Salvando...' : 'Redefinir senha'">Redefinir senha</span>
                        </button>
