...
/**
 * Template de e-mail: Aviso de expiração de assinatura — 3 dias restantes
 *
 ...
 *   @var int    $daysLeft         Dias restantes até a expiração
...
$daysLeft         = isset($daysLeft)         ? (int)    $daysLeft         : 3;
...
<head>
    ...
    <title>Sua assinatura expira em <?php echo $daysLeft; ?> dias — GarimpAções</title>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#060b11;">
        <tr>
            <td align="center" style="padding:48px 16px;">
                ...
                <!-- Container principal -->
                <table border="0" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;width:100%;background-color:#0d1520;border-radius:10px;overflow:hidden;border:1px solid rgba(245,158,11,0.25);">
                    ...
                    <!-- Faixa de alerta âmbar -->
                    <tr>
                        <td style="background-color:#f59e0b;height:2px;font-size:0;">&nbsp;</td>
                    </tr>

                    <!-- Banner de alerta -->
                    <tr>
                        <td align="center" style="background-color:#142030;padding:18px 48px;border-bottom:1px solid rgba(245,158,11,0.15);">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="font-size:13px;font-weight:700;color:#f59e0b;font-family:Arial,Helvetica,sans-serif;letter-spacing:0.5px;">
                                        ⚠️ &nbsp;AVISO: SUA ASSINATURA EXPIRA EM <?php echo $daysLeft; ?> DIA<?php echo $daysLeft > 1 ? 'S' : ''; ?>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="font-size:15px;color:#b0bec5;line-height:1.75;padding-bottom:24px;font-family:Arial,Helvetica,sans-serif;">
                                        Sua assinatura <strong style="color:#e2e8f0;"><?php echo htmlspecialchars($planLabel, ENT_QUOTES, 'UTF-8'); ?></strong>
                                        do GarimpAções está prestes a vencer. Você tem apenas
                                        <strong style="color:#f59e0b;"><?php echo $daysLeft; ?> dia<?php echo $daysLeft > 1 ? 's' : ''; ?></strong>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#142030;border-radius:8px;border:1px solid rgba(255,255,255,0.06);">
                                            <tr>
                                                <td style="padding:20px 24px;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td width="50%" style="font-size:13px;color:#7a8ba0;font-family:Arial,Helvetica,sans-serif;">Plano atual</td>
                                                            <td width="50%" style="font-size:13px;color:#7a8ba0;font-family:Arial,Helvetica,sans-serif;text-align:right;">Expira em</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-size:16px;font-weight:700;color:#e2e8f0;padding-top:6px;font-family:Arial,Helvetica,sans-serif;">
                                                                <?php echo htmlspecialchars($planLabel, ENT_QUOTES, 'UTF-8'); ?>
                                                            </td>
                                                            <td style="font-size:16px;font-weight:700;color:#f59e0b;padding-top:6px;font-family:Arial,Helvetica,sans-serif;text-align:right;">
                                                                <?php echo htmlspecialchars($expiresFormatted, ENT_QUOTES, 'UTF-8'); ?>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                ...
                                <tr>
                                    <td style="font-size:15px;color:#b0bec5;line-height:1.75;padding-bottom:8px;font-family:Arial,Helvetica,sans-serif;">
                                        Após a expiração, você perderá acesso a:
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom:32px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="font-size:14px;color:#7a8ba0;line-height:1.9;font-family:Arial,Helvetica,sans-serif;padding-left:8px;">
