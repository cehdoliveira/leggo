...
<head>
    ...
    <title>Seus dados de acesso — <?php echo htmlspecialchars(constant('cTitle')); ?></title>
</head>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="font-size:15px;color:#b0bec5;line-height:1.75;padding-bottom:32px;font-family:Arial,Helvetica,sans-serif;">
                                        Seu cadastro no <strong style="color:#e2e8f0;"><?php echo htmlspecialchars(constant('cTitle')); ?></strong> foi realizado com sucesso.
