...
<title>Confirme seu e-mail &mdash; <?php echo htmlspecialchars(constant('cTitle')); ?></title>
</head>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="background-color:#2563eb;border-radius:8px;">
                        <a href="<?php echo htmlspecialchars($verifyLink, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" style="display:inline-block;padding:15px 40px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:8px;">Confirmar meu e-mail</a>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td style="background-color:#142030;border-left:3px solid #2563eb;padding:14px 18px;border-radius:0 4px 4px 0;">
                  <p style="margin:0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#7a8ba0;line-height:1.65;">&#9203; Este link é válido por <strong style="color:#e2e8f0;font-family:Arial,Helvetica,sans-serif;">72 horas</strong> a partir do recebimento deste e-mail. Se você não realizou este cadastro, basta ignorar esta mensagem &mdash; sua conta não será ativada.</p>
                </td>
              </tr>
              <tr>
                <td style="padding-top:24px;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#7a8ba0;line-height:1.65;word-break:break-all;">
                  ...
                  <a href="<?php echo htmlspecialchars($verifyLink, ENT_QUOTES, 'UTF-8'); ?>" style="color:#3b82f6;text-decoration:none;font-family:Arial,Helvetica,sans-serif;"><?php echo htmlspecialchars($verifyLink, ENT_QUOTES, 'UTF-8'); ?></a>
                </td>
              </tr>
            </table>
          </td>
