...
<head>
    ...
    <title>Redefinição de senha — GarimpAções</title>
</head>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td style="font-size:15px;color:#b0bec5;line-height:1.75;padding-bottom:32px;font-family:Arial,Helvetica,sans-serif;">
                                        Recebemos uma solicitação para redefinir a senha da sua conta no <strong style="color:#e2e8f0;">GarimpAções</strong>.
